                ...
                <div class="flex flex-col md:mt-0 mt-20 justify-center">
                    <div class="text-white lg:text-left" data-aos="fade-right">
                        ...
                        <p class="text-blue-200 font-medium text-lg md:text-xl mt-4" data-aos="fade-right"
                            data-aos-delay="100">
                            Front-End Dev & Freelancer · HTML · CSS · JS · React · Vue
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        <button @click="downloadCV" class="border-2 border-blue-400 px-8 md:px-10 py-4 rounded-xl relative group w-full sm:w-max flex justify-center hover:bg-blue-400/10
...
const downloadCV = () => {
    ...
    link.href = '/Ibti-CV.pdf';
    link.download = 'Ibti-CV.pdf';
    link.click();
};
</script>