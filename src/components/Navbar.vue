<template>
    <header class="flex justify-between items-center p-6 bg-opacity-50 relative z-20">
        <div class="text-3xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
            Ibti <span class="font-black">Portfolio</span>
        </div>
        ...
        md:space-x-5 md:space-y-0">
            ...
            <div class="mt-8 md:mt-0 md:ml-8">
                <button @click="scrollToSection('#contact')"
                    class="px-6 py-2.5 bg-linear-to-r from-blue-500 to-cyan-500 text-white rounded-full hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105">
                    Let's Talk
                </button>
            </div>
        </nav>
